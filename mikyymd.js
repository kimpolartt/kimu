...
const totalFitur = () =>{
var mytext = fs.readFileSync("./mikyymd.js").toString()
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            case 'cekprefix': {
                ...
                //Balas Cepat
            case 'p': {
                m.reply(`Ketik #menu Untuk Melihat List Menu Bot Mek`)
                }
                break
            ...
            let ments = [ownernya, me, ini_mark]
                anu = `Halo Kak 👋. Saya adalah bot WhatsApp otomatis yang dapat membantu melakukan sesuatu, mencari dan mendapatkan data atau informasi melalui WhatsApp.

┏━⊜ 𝙄𝙉𝙁𝙊 𝙐𝙎𝙀𝙍 ━⊜
父 Name : ${pushname}
父 Number : ${m.sender.split('@')[0]}
父 Status : ${isCreator ? "Owner 👑️":"User ⚔️"}
父 User : ${isPremium ? 'Premium 👑' : 'Gratisan 🗿'}
父 Limit : ${isCreator ? 'Unlimited 👑' : `${db.data.users[m.sender].limit}`}
┗━━━━━━━━━━⬣

┏━⊜ 𝙄𝙉𝙁𝙊 𝘽𝙊𝙏 ━⊜
父 Name : ${global.namabot}
父 Owner : ${global.namaowner}
父 Prefix : ( ${prefix} )
父 Mode : ${conn.public ? 'Public-Mode ✅' : 'Self-Mode ❌'}
父 Platform : ${os.platform()}
父 Runtime : ${runtime(process.uptime())}
父 Language : Javascript
父 Total User : ${Object.keys(global.db.data.users).length}
父 Total Fitur : ${totalFitur()}
┗━━━━━━━━━━⬣
 ${readmore}
 *THANKS TO:*
• *Allah Swt.*
...
let { UploadFileUgu, webp2mp4File, TelegraPh } = require('./lib/uploader')
try {
const meks = await conn.downloadAndSaveMediaMessage(quoted)
const mkes = await TelegraPh(meks)
conn.sendMessage(from, { image: { url: `https://api.itsrose.life/image/unblur?url=${mkes}&apikey=d2d1ffb58da6827d281b285c` }, caption: "Sukses" }, { quoted: m })
} catch (err) {
m.reply(`Kirim Reply Video Dengan Caption ${prefix + command}`)
}
}
break
...
┗━━━━━━━━━━⬣`
            ...
            const more = String.fromCharCode(8206)
            const readmore = more.repeat(4001) 
            let anu = `Halo Kak 👋. Saya adalah bot WhatsApp otomatis yang dapat membantu melakukan sesuatu, mencari dan mendapatkan data atau informasi melalui WhatsApp.
...
┗━━━━━━━━━━⬣͏͏͏͏͏͏͏͏
 ${readmore}
┏━━⊜ *_MENU_* ━⊜͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏
┃⋄ ${prefix}newfitur
┃⋄ ${prefix}sanzzmenu
┃⋄ ${prefix}anonymenu
┃⋄ ${prefix}wibumenu
...
┗━━━━━━━━━━⬣`
        ...
        console.log("Eror Di Bagian mikyymd.js "+util.format(err))
